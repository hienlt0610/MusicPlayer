package hienlt.app.connectdemo.view;
...
public class LrcView extends View implements ILrcView{
	...
	private int mLrcHightlightFontSize = 35; 	// font size of lrc hightlight
	private int mMinLrcFontSize = 15;
	private int mMaxLrcFontSize = 35;
	private int mPaddingY = 10;		// padding of each row
	private int mSeekLinePaddingX = 20; // Seek line padding x
	...
	protected void onDraw(Canvas canvas) {
		...
		mPaint.setColor(mHignlightRowColor);
		mPaint.setTextSize(mLrcHightlightFontSize);
		mPaint.setTextAlign(Align.CENTER);
		...
		if(mDisplayMode == DISPLAY_MODE_SEEK){
			...
			canvas.drawText(mLrcRows.get(mHignlightRow).strTime, mSeekLinePaddingX, highlightRowY-5, mPaint);
		}
