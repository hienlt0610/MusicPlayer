 ...
 */
public class AlbumDetailFragment extends HLBaseFragment implements ParallaxRecyclerAdapter.OnClickEvent {
    ...
    public static AlbumDetailFragment getInstance(String albumName) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (albumName == null) getActivity().getSupportFragmentManager().popBackStack();
        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        list = SongProvider.getInstance(getActivity()).getListSongByAlbum(albumName);
        ...
        Bitmap bitmap = cache.getBitmap(albumName.trim());
        if (bitmap != null)
